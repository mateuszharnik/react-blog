...
db@seed-production:
	...
	@cross-env NODE_ENV=production APP_ENV=production npx babel-node ./src/server/seeds/index.js
...
db@seed-development:
	...
	@cross-env NODE_ENV=development APP_ENV=development npx babel-node ./src/server/seeds/index.js
...
db@seed-e2e:
	...
	@cross-env NODE_ENV=test APP_ENV=e2e npx babel-node ./src/server/seeds/index.js
...
db@seed-staging:
	...
	@cross-env NODE_ENV=production APP_ENV=staging npx babel-node ./src/server/seeds/index.js
...
db@seed-testing:
	...
	@cross-env NODE_ENV=production APP_ENV=testing npx babel-node ./src/server/seeds/index.js
...
db@clean-production:
	@cross-env NODE_ENV=production APP_ENV=production npx babel-node ./src/server/seeds/clean.js

.ONESHELL:
db@clean-development: # Remove data from local database
db@clean-development:
	@cross-env NODE_ENV=development APP_ENV=development npx babel-node ./src/server/seeds/clean.js
...
db@clean-e2e:
	@cross-env NODE_ENV=test APP_ENV=e2e npx babel-node ./src/server/seeds/clean.js

.ONESHELL:
db@clean-staging: # Remove data from staging database
db@clean-staging:
	@cross-env NODE_ENV=production APP_ENV=staging npx babel-node ./src/server/seeds/clean.js

.ONESHELL:
db@clean-testing: # Remove data from testing database
db@clean-testing:
	@cross-env NODE_ENV=production APP_ENV=testing npx babel-node ./src/server/seeds/clean.js
...
migration@up-production:
	@cross-env NODE_ENV=production APP_ENV=production npx migrate-mongo up -f migrations.config.js

.ONESHELL:
migration@up-development: # Run migrations for local environment
migration@up-development:
	@cross-env NODE_ENV=development APP_ENV=development npx migrate-mongo up -f migrations.config.js

.ONESHELL:
migration@up-test: # Run migrations for test environment
migration@up-test:
	@cross-env NODE_ENV=test APP_ENV=test npx migrate-mongo up -f migrations.config.js

.ONESHELL:
migration@up-e2e: # Run migrations for e2e environment
migration@up-e2e:
	@cross-env NODE_ENV=test APP_ENV=e2e npx migrate-mongo up -f migrations.config.js

.ONESHELL:
migration@up-staging: # Run migrations for staging environment
migration@up-staging:
	@cross-env NODE_ENV=production APP_ENV=staging npx migrate-mongo up -f migrations.config.js

.ONESHELL:
migration@up-testing: # Run migrations for testing environment
migration@up-testing:
	@cross-env NODE_ENV=production APP_ENV=testing npx migrate-mongo up -f migrations.config.js
...
migration@down: check-env
	@make migration@down-$(ENV)

.ONESHELL:
migration@down-production: # Revert migration for production environment
migration@down-production:
	@cross-env NODE_ENV=production APP_ENV=production npx migrate-mongo down -f migrations.config.js

.ONESHELL:
migration@down-development: # Revert migration for local environment
migration@down-development:
	@cross-env NODE_ENV=development APP_ENV=development npx migrate-mongo down -f migrations.config.js

.ONESHELL:
migration@down-test: # Revert migration for test environment
migration@down-test:
	@cross-env NODE_ENV=test APP_ENV=test npx migrate-mongo down -f migrations.config.js

.ONESHELL:
migration@down-e2e: # Revert migration for e2e environment
migration@down-e2e:
	@cross-env NODE_ENV=test APP_ENV=e2e npx migrate-mongo down -f migrations.config.js

.ONESHELL:
migration@down-staging: # Revert migration for staging environment
migration@down-staging:
	@cross-env NODE_ENV=production APP_ENV=staging npx migrate-mongo down -f migrations.config.js

.ONESHELL:
migration@down-testing: # Revert migration for testing environment
migration@down-testing:
	@cross-env NODE_ENV=production APP_ENV=testing npx migrate-mongo down -f migrations.config.js
...
migration@status: check-env
	@make migration@status-$(ENV)

.ONESHELL:
migration@status-production: # Show migrations status for production environment
migration@status-production:
	@cross-env NODE_ENV=production APP_ENV=production npx migrate-mongo status -f migrations.config.js

.ONESHELL:
migration@status-development: # Show migrations status for local environment
migration@status-development:
	@cross-env NODE_ENV=development APP_ENV=development npx migrate-mongo status -f migrations.config.js

.ONESHELL:
migration@status-test: # Show migrations status for test environment
migration@status-test:
	@cross-env NODE_ENV=test APP_ENV=test npx migrate-mongo status -f migrations.config.js

.ONESHELL:
migration@status-e2e: # Show migrations status for e2e environment
migration@status-e2e:
	@cross-env NODE_ENV=test APP_ENV=e2e npx migrate-mongo status -f migrations.config.js

.ONESHELL:
migration@status-staging: # Show migrations status for staging environment
migration@status-staging:
	@cross-env NODE_ENV=production APP_ENV=staging npx migrate-mongo status -f migrations.config.js

.ONESHELL:
migration@status-testing: # Show migrations status for testing environment
migration@status-testing:
	@cross-env NODE_ENV=production APP_ENV=testing npx migrate-mongo status -f migrations.config.js
